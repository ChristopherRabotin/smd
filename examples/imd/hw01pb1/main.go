...
func main() {
	...
	sc.LogInfo()
	initEarthOrbit := smd.NewOrbitFromOE(smd.Earth.Radius+400, 0.1, 10, 10, 10, 36, smd.Earth)
	soiEarthOrbit := smd.NewOrbitFromOE(smd.Earth.SOI, 0.1, 10, 10, 10, 36, smd.Earth)
