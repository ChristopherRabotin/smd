...
func main() {
	...
	*/
	...
	scMars.LogInfo()
	astroM, _ := dynamics.NewAstro(scMars, InitialMarsOrbit(), start.Add(time.Duration(7*31*24)*time.Hour), start, dynamics.ExportConfig{Filename: "IM", OE: false, Cosmo: false, Timestamp: false})
	astroM.Propagate()
	/*
