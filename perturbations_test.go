...
func TestPert3rdBody(t *testing.T) {
	...
	testValues := []struct {
		...
		{Sun, []float64{-3.9833296984759585e-10, 3.984361621969917e-10, -2.6890670741004563e-10, 0, 0, 0, 0}},
		{Mars, []float64{-8.288290218173807e-18, -1.3645123997762882e-17, -1.0865175280609544e-17, 0, 0, 0, 0}},
